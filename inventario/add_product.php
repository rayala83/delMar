...
<?php
 if(isset($_POST['add_product'])){
   $req_fields = array('product-title','product-categorie','product-quantity','product-tipo','buying-price', 'saleing-price' );
   validate_fields($req_fields);
   if(empty($errors)){
     $p_name  = remove_junk($db->escape($_POST['product-title']));
     $p_cat   = remove_junk($db->escape($_POST['product-categorie']));
	 $p_tipo   = remove_junk($db->escape($_POST['product-tipo']));
     ...
     $query .=" name,quantity,buy_price,sale_price,tipo,categorie_id,media_id,date";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$p_qty}', '{$p_buy}', '{$p_sale}', '{$p_tipo}', '{$p_cat}', '{$media_id}', '{$date}'";
     $query .=")";
          ...
          <form method="post" action="add_product.php" class="clearfix">
              ...
              <div class="form-group">
                <div class="row">
				  ...
				  <div class="col-md-4">
					<select class="form-control" name="product-tipo">
